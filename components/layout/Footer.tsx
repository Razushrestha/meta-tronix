  ...
  return (
    <footer className="border-t border-brand-border bg-brand-footer">
      ...
      <div className="border-t border-brand-border bg-brand-footer">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-brand-muted">
          <p className="text-brand-navy font-medium">
            © {new Date().getFullYear()} Meta Tronix. All rights reserved.
          </p>
          <p>Built for performance. Engineered for scale.</p>
        </div>
      </div>
    </footer>
  );
